export const CHECKOUT_FEATURE_GATES = {
  ...
  INVENTORY_HOLD_TTL_ENABLED: "inventory_hold_ttl_enabled",
} as const;
...
export const DEFAULT_FREE_SHIP_THRESHOLD = 150;
export const DEFAULT_FLAT_SHIPPING_FEE = 9.99;
...
export const COUPON_CATALOG: Record<string, CouponDefinition> = {
  ...
  MIN200: { code: "MIN200", rate: 0.15, minSpend: 200 },
};
